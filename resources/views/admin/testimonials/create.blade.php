    ...
    <div class="col-lg-9 col-xl-7 mx-auto">
        <div class="custom-table-container">
            <div class="table-title-area mb-4">
                <h3 class="table-title"><i class="fa-solid fa-plus text-red me-2"></i> Add Client Review</h3>
            ...
            <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-custom" value="{{ old('name') }}" required>
                    </div>
                    <div class="col-md-6">
                        <label for="company">Company</label>
                        <input type="text" name="company" id="company" class="form-control form-control-custom" value="{{ old('company') }}">
                    </div>
                    <div class="col-md-6">
                        <label for="designation">Designation</label>
                        <input type="text" name="designation" id="designation" class="form-control form-control-custom" value="{{ old('designation') }}">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="review" id="review" rows="5" class="form-control form-control-custom" required>{{ old('review') }}</textarea>
                    </div>
                    <div class="col-md-8">
                        ...
                        <small class="text-muted d-block mt-2">Recommended square image, 300x300 or larger.</small>
                    </div>
                ...
                <div class="d-grid mt-4">
                    <button type="submit" class="btn btn-red py-2 fw-semibold">
                        <i class="fa-solid fa-floppy-disk me-2"></i> Save Review
                    </button>
                </div>
            </form>
        </div>

...
<div class="row g-3">
 ...
 <div class="col-md-6"><label>SEO Meta Title</label><input name="meta_title" maxlength="255" class="form-control form-control-custom" value="{{ old('meta_title',$blog->meta_title ?? '') }}" placeholder="Defaults to blog title if empty"><small class="text-muted">Recommended: 50–60 characters.</small></div>
 <div class="col-md-6"><label>SEO Meta Description</label><textarea name="meta_description" maxlength="320" rows="3" class="form-control form-control-custom" placeholder="Defaults to short excerpt if empty">{{ old('meta_description',$blog->meta_description ?? '') }}</textarea><small class="text-muted">Recommended: 150–160 characters.</small></div>
